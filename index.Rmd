...
As an avid reader and introvert, I naturally became gravitated to these books to gain a better understanding of myself and transform the way I view life.
I wanted to analyze these trends to draw conclusions about possible reasons why a certain period of time had a spike or drop in library checkouts and compare the numbers between these books to see which book is the most popular.
...
This bar chart shows the amount of library checkouts for each of Cain's books from January 2012 to January 2023.
