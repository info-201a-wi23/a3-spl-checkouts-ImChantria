...
As an avid reader and introvert, I naturally became gravitated to these books to gain a better understanding of myself and transform the way I view life. I wanted to analyze these trends to draw conclusions about possible reasons why a certain period of time had a spike or drop in library checkouts and compare the numbers between these books to see which book is the most popular.

### References

Seattle.(n.d.). Checkouts by Title. Retrieved from Seattle Open Data Portal
...
Based on the data, we can see that Cain's book *Quiet: The Power of Introverts* has received noticeably more library checkouts (865 total) from 2015 to 2023 compared to *Bittersweet: How Sorrow and Longing Make Us Whole* (48 total.
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "hide", fig.keep = "all" code = readLines("Getting-Started-with-A3-SPL-Data.R")}
cain_plot
```
...
cain_plot_2
```
This line plot shows the trend between physical and digital book checkouts from January 2012 to January 2023. Physical book checkouts (green line) spiked from 2012 to 2014 and slowly began decreasing as digital book checkouts (orange line) began to take over from 2017 to 2022. The physical book checkouts had a noticeable spike around 2022, which is during the time Cain released her second book. We may be able to infer that digital library checkouts increased as technology became more advanced. The 2020 pandemic may have played a role in digital checkouts because libraries were most likely closed during this time period.
...
cain_plot_3
```
This bar chart shows the amount of library checkouts for each of Cain's books from January 2012 to January 2023. There were **48 total** checkouts for *Bittersweet* and **865 total** checkouts for *Quiet*. 